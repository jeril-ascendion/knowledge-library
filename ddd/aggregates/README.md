...
> **Section:** `ddd/` | **Subsection:** `aggregates/`  
...
### 1. Intentional Design for Aggregates
...
### RAG Integration for Aggregates
...
*Section: `ddd/aggregates/` | Aligned to TOGAF · NIST · ISO 27001 · AWS Well-Architected*
