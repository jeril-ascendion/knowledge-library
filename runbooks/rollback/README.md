...
### 1. Intentional Design for Rollback Runbook
...
### RAG Integration for Rollback Runbook
...
*Section: `runbooks/rollback/` | Aligned to TOGAF · NIST · ISO 27001 · AWS Well-Architected*
