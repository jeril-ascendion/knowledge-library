...
### 1. Intentional Design for Domain-Specific Principles
...
### RAG Integration for Domain-Specific Principles
...
*Section: `principles/domain-specific/` | Aligned to TOGAF · NIST · ISO 27001 · AWS Well-Architected*
