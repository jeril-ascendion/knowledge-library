...
cat > "$PREVIEW/fourteen-emblems.html" <<'HTMLHEAD'
<!DOCTYPE html>
...
<h1>Fourteen pages, fourteen motion mechanics — System Design group complete</h1>
...
tar czf "$OUT/ascendion-engineering-v26.tar.gz" \
...
cp "$PREVIEW/fourteen-emblems.html"                       "$OUT/fourteen-emblems-v26.html"
cp "$PREVIEW/patterns-data-preview.html"                  "$OUT/data-patterns-preview-v26.html"
cp "$PREVIEW/knowledge-graph-preview.html"                "$OUT/knowledge-graph-preview-v26.html"
cp "$PREVIEW/system-design-edge-ai-preview.html"          "$OUT/edge-ai-preview-v26.html"
cp "$PREVIEW/system-design-event-driven-preview.html"     "$OUT/event-driven-preview-v26.html"
cp "$PREVIEW/system-design-ha-dr-preview.html"            "$OUT/ha-dr-preview-v26.html"
cp "$PREVIEW/system-design-scalable-preview.html"         "$OUT/scalable-preview-v26.html"
...
tar tzf "$OUT/ascendion-engineering-v26.tar.gz" | head -30
