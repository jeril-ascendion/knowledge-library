...
cat > "$PREVIEW/forty-emblems.html" <<'HTMLHEAD'
<!DOCTYPE html>
...
<h1>Forty pages, forty motion mechanics — Observability group complete</h1>
...
# ─── v32 cleanup script (deletes orphan stub directories from user's repo) ───
cat > "$REPO/tools/CLEANUP_v32.sh" <<'CLEANUP_EOF'
#!/usr/bin/env bash
...
CLEANUP_EOF
chmod +x "$REPO/tools/CLEANUP_v32.sh"

tar czf "$OUT/ascendion-engineering-v32.tar.gz" \
    --exclude='.git' --exclude='node_modules' --exclude='*.pyc' \
    tools src content infra .github

# Also expose CLEANUP_v32.sh as a standalone output (user can run it before
# extracting the tarball, without having to extract the tarball first).
cp "$REPO/tools/CLEANUP_v32.sh" "$OUT/CLEANUP_v32.sh"

# AI-Native preview copies
cp "$PREVIEW/ai-native-architecture-preview.html" "$OUT/ai-native-architecture-preview-v32.html"
cp "$PREVIEW/ai-native-ethics-preview.html"       "$OUT/ai-native-ethics-preview-v32.html"
cp "$PREVIEW/ai-native-monitoring-preview.html"   "$OUT/ai-native-monitoring-preview-v32.html"
cp "$PREVIEW/ai-native-rag-preview.html"          "$OUT/ai-native-rag-preview-v32.html"
cp "$PREVIEW/ai-native-security-preview.html"     "$OUT/ai-native-security-preview-v32.html"

# Governance preview copies (v32)
cp "$PREVIEW/governance-checklists-preview.html"        "$OUT/governance-checklists-preview-v32.html"
cp "$PREVIEW/governance-review-templates-preview.html"  "$OUT/governance-review-templates-preview-v32.html"
cp "$PREVIEW/governance-roles-preview.html"             "$OUT/governance-roles-preview-v32.html"
cp "$PREVIEW/governance-scorecards-preview.html"        "$OUT/governance-scorecards-preview-v32.html"

# Observability preview copies (v32)
cp "$PREVIEW/observability-incident-response-preview.html"  "$OUT/observability-incident-response-preview-v32.html"
cp "$PREVIEW/observability-logs-preview.html"               "$OUT/observability-logs-preview-v32.html"
cp "$PREVIEW/observability-metrics-preview.html"            "$OUT/observability-metrics-preview-v32.html"
cp "$PREVIEW/observability-sli-slo-preview.html"            "$OUT/observability-sli-slo-preview-v32.html"
cp "$PREVIEW/observability-traces-preview.html"             "$OUT/observability-traces-preview-v32.html"
...
cp "$PREVIEW/forty-emblems.html"                       "$OUT/forty-emblems-v32.html"
cp "$PREVIEW/patterns-data-preview.html"                  "$OUT/data-patterns-preview-v32.html"
cp "$PREVIEW/knowledge-graph-preview.html"                "$OUT/knowledge-graph-preview-v32.html"
cp "$PREVIEW/system-design-edge-ai-preview.html"          "$OUT/edge-ai-preview-v32.html"
cp "$PREVIEW/system-design-event-driven-preview.html"     "$OUT/event-driven-preview-v32.html"
cp "$PREVIEW/system-design-ha-dr-preview.html"            "$OUT/ha-dr-preview-v32.html"
cp "$PREVIEW/system-design-scalable-preview.html"         "$OUT/scalable-preview-v32.html"
cp "$PREVIEW/technology-ui-ux-cx-preview.html"            "$OUT/ui-ux-cx-preview-v32.html"
cp "$PREVIEW/technology-api-backend-preview.html"         "$OUT/api-backend-preview-v32.html"
cp "$PREVIEW/technology-databases-preview.html"           "$OUT/databases-preview-v32.html"
cp "$PREVIEW/technology-cloud-preview.html"               "$OUT/cloud-preview-v32.html"
cp "$PREVIEW/technology-devops-preview.html"              "$OUT/devops-preview-v32.html"
cp "$PREVIEW/technology-practice-circles-preview.html"    "$OUT/practice-circles-preview-v32.html"
cp "$PREVIEW/technology-engagement-models-preview.html"   "$OUT/engagement-models-preview-v32.html"
cp "$PREVIEW/security-application-security-preview.html"           "$OUT/application-security-preview-v32.html"
cp "$PREVIEW/security-authentication-authorization-preview.html"   "$OUT/authentication-authorization-preview-v32.html"
cp "$PREVIEW/security-cloud-security-preview.html"                 "$OUT/cloud-security-preview-v32.html"
cp "$PREVIEW/security-encryption-preview.html"                     "$OUT/encryption-preview-v32.html"
cp "$PREVIEW/security-vulnerability-management-preview.html"       "$OUT/vulnerability-management-preview-v32.html"
...
tar tzf "$OUT/ascendion-engineering-v32.tar.gz" | head -30
