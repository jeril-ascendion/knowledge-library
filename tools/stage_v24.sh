...
cat > "$PREVIEW/nine-emblems.html" <<'HTMLHEAD'
<!DOCTYPE html>
...
<h1>Nine pages, nine motion mechanics</h1>
...
tar czf "$OUT/ascendion-engineering-v24.tar.gz" \
...
cp "$PREVIEW/nine-emblems.html"             "$OUT/nine-emblems-v24.html"
cp "$PREVIEW/patterns-data-preview.html"   "$OUT/data-patterns-preview-v24.html"
cp "$PREVIEW/knowledge-graph-preview.html" "$OUT/knowledge-graph-preview-v24.html"
...
tar tzf "$OUT/ascendion-engineering-v24.tar.gz" | head -30
