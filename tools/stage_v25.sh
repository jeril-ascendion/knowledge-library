...
cat > "$PREVIEW/ten-emblems.html" <<'HTMLHEAD'
<!DOCTYPE html>
...
<h1>Ten pages, ten motion mechanics — Patterns group complete</h1>
...
tar czf "$OUT/ascendion-engineering-v25.tar.gz" \
...
cp "$PREVIEW/ten-emblems.html"             "$OUT/ten-emblems-v25.html"
cp "$PREVIEW/patterns-data-preview.html"   "$OUT/data-patterns-preview-v25.html"
cp "$PREVIEW/knowledge-graph-preview.html" "$OUT/knowledge-graph-preview-v25.html"
...
tar tzf "$OUT/ascendion-engineering-v25.tar.gz" | head -30
