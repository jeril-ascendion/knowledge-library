...
cat > "$PREVIEW/eight-emblems.html" <<'HTMLHEAD'
<!DOCTYPE html>
...
<h1>Eight pages, eight motion mechanics</h1>
...
tar czf "$OUT/ascendion-engineering-v23.tar.gz" \
...
cp "$PREVIEW/eight-emblems.html"             "$OUT/eight-emblems-v23.html"
cp "$PREVIEW/patterns-data-preview.html"   "$OUT/data-patterns-preview-v23.html"
cp "$PREVIEW/knowledge-graph-preview.html" "$OUT/knowledge-graph-preview-v23.html"
...
tar tzf "$OUT/ascendion-engineering-v23.tar.gz" | head -30
