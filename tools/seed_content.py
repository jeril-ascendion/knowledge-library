...
NESTED_TAXONOMY = {
    "technology/mobile": {
        ...
        "core-architecture-goals":                "Core Architecture Goals",
        "technology-decisions":                   "Technology Decisions",
        "architecture-style-and-layering":        "Architecture Style and Layering",
        "mobile-state-management":                "Mobile State Management",
        "security-and-compliance-architecture":   "Security and Compliance Architecture",
        "ssdlc":                                  "Secure SDLC",
        "offline-reliability":                    "Offline Reliability",
        "api-integration-architecture":           "API Integration Architecture",
        "scalability-modularization":             "Scalability — Modularization",
        "scalability-evolution-model":            "Scalability Evolution Model",
        ...
        "mobile-reliability-engineering":         "Mobile Reliability Engineering",
        "cicd-engineering-operations":            "CI/CD Engineering Operations",
        "testing-strategy":                       "Testing Strategy",
        "ux-mobile-platform":                     "UX Mobile Platform",
        "runtime-architecture-flows":             "Runtime Architecture Flows",
        "lifecycle-evolution-governance":         "Lifecycle Evolution Governance",
        "build-vs-buy":                           "Build vs Buy",
        "aiml-integration":                       "AI/ML Integration",
        "organizational-scaling-model":           "Organizational Scaling Model",
        "anti-patterns-failure-scenarios":        "Anti-Patterns & Failure Scenarios",
        "migration-evolution-strategy":           "Migration & Evolution Strategy",
